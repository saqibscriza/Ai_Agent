          ...
          <div className="row " style={{ marginTop: '-10px' }}>
            ...
            <div className="col-lg-6 col-md-12 col-sm-12 ">
              <div className='d-flex breadcrmBtn ' style={{ marginTop: '-8px' }}>
                <div><button type="button" class="btn btn-md  playground me-1" >Playground</button></div>
                <div><button type="button" class="btn  newAgent">+ New Agent</button></div>
              </div>
            </div>
          </div>
        </div>
              ...
              <table className="table table-sm table-striped text-center">
                <thead>
                  <tr className="heading-16 text-color-000" style={{ fontWeight: "500" }}>
                    <th className="no-wrap no-shrink">Name</th>
                    <th className="no-wrap no-shrink">Created by</th>
                    <th className="no-wrap no-shrink">Created at</th>
                    <th className="no-wrap no-shrink">Action</th>
                  </tr>
                </thead>
                <tbody className="heading-14 align-middle greyTextColor">
                  <tr className="heading-14">
                    <td className="greyText pe-0 no-wrap no-shrink">My Data</td>
                    <td className="greyText pe-0 no-wrap no-shrink">My Data</td>
                    <td className="greyText pe-0 no-wrap no-shrink">My Data</td>
                    <td className="greyText pe-0 no-wrap no-shrink">My Data</td>
                  </tr>
