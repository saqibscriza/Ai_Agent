        ...
        <div className='mainPage'>
          <div className='mt-3 '>
            ...
            <div className="row mt-2 mx-1">
              ...
              <div className="col-lg-6 col-md-12 col-sm-12 text-end">
                <div>
                  <button className='chooseBtn' data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">Update Email</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className='mt-3 '>
            ...
            <div className="row mt-2 mx-1">
              ...
              <div className="col-lg-6 col-md-12 col-sm-12 text-end">
                <div>
                  <button className='chooseBtn'>Manage Sharing</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className='mt-3 '>
            ...
            <div className="row mt-2 mx-1">
              ...
              <div className="col-lg-6 col-md-12 col-sm-12 text-end">
                <div>
                  <button className='chooseBtn'>Manage Default Sharing</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className='mt-3 '>
            ...
            <div className="row mt-2 mx-1">
              ...
              <div className="col-lg-6 col-md-12 col-sm-12 text-end">
                <div>
                  <button className='chooseBtn'>Two-Factor Authentication</button>
                </div>
              </div>
            </div>
          </div>
